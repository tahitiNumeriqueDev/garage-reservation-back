...
public interface CreneauRepository extends JpaRepository<Creneau, Long> {
    ...
    List<Creneau> findCreneauxBetweenDates(@Param("dateDebut") LocalDateTime dateDebut, 
    ...
    List<Creneau> findCreneauxDisponiblesBetweenDates(@Param("dateDebut") LocalDateTime dateDebut, 
                                                      @Param("dateFin") LocalDateTime dateFin);
    ...
    List<Creneau> findCreneauxByDate(@Param("date") LocalDateTime date);
    ...
    List<Creneau> findCreneauxDisponiblesByDate(@Param("date") LocalDateTime date);
    ...
    List<Creneau> findCreneauxByWeek(@Param("date") LocalDateTime date);
    ...
    List<Creneau> findCreneauxDisponiblesByWeek(@Param("date") LocalDateTime date);
